...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, AccountDto> accountConsumerListenerFactory() {
        Map<String, Object> props = configurationPropsMap("ru.t1.java.demo.dto.AccountDto");
    ...
    public ConsumerFactory<String, TransactionDto> transactionConsumerListenerFactory() {
        Map<String, Object> props = configurationPropsMap("ru.t1.java.demo.dto.TransactionDto");
